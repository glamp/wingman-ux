...
- **Custom Domain** (session-abc123.wingman.dev) for professional user experience
...
- Basic PM access page at `session-{id}.wingman.dev`
...
- **Domain:** `*.wingman.dev` wildcard DNS
...
- Domain registration (wingman.dev)
